...
export const AI_PROVIDERS = [
  ...
  { id: 'gemini', name: 'Google Gemini', short: 'Gemini', color: '#4285F4', needsKey: true, free: true, badge: 'Бесплатный tier', defaultModel: 'gemini-2.5-flash', models: ['gemini-2.5-flash', 'gemini-2.0-flash', 'gemini-1.5-pro', 'gemini-1.5-flash'], desc: 'Бесплатный tier, быстрый', hint: 'aistudio.google.com → Get API key', keyPrefix: 'AIza' },
